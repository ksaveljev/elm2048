...
data Dir = Up | Down | Left | Right | None -- the direction to shift the grid

type Controls = { -- define the user controls
    tilePushDirection : Dir       -- the direction the user wants to slide the grid
